...
public interface FixturePageFactory extends PageFactory {
  ...
  FixturePageWithMethodNotIncludingSimpleNameOfDeclaringClassInMethodName getFixturePageWithMethodNotIncludingSimpleNameOfDeclaringClassInMethodName();
  FixturePageThatIncludesAComponentWithNoImpl getFixturePageThatIncludesAComponentWithNoImpl();
  FixturePageWithTypeParametersInMethods getFixturePageWithTypeParametersInMethods();
}
